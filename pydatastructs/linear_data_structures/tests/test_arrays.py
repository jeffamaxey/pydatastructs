...
def test_OneDimensionalArray():
    ...
    assert raises(TypeError, lambda: ODA(int, 5.0, {1, 2, 3}))
    assert raises(TypeError, lambda: ODA(int, 5.0))
    assert raises(TypeError, lambda: ODA(int, {1, 2, 3}))
    ...
    assert raises(TypeError, lambda: ODA(int, 5.0, {1, 2, 3}, backend=Backend.CPP))
    assert raises(TypeError, lambda: ODA(int, 5.0, backend=Backend.CPP))
    assert raises(TypeError, lambda: ODA(int, {1, 2, 3}, backend=Backend.CPP))
